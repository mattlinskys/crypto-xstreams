...
import UniswapV2Stream, { IUniswapV2StreamConfig } from 'streams/uniswap-v2';

interface PancakeSwapConfig extends IUniswapV2StreamConfig {}

@StaticImplements<IStreamStatic<PancakeSwapConfig, any>>()
class PancakeSwapStream extends UniswapV2Stream {
  public static id: TExchangeId = 'pancake-swap';

  protected override get multicallAddress() {
    return (
  ...
  protected override get factoryAddress() {
    return (
      this.config.factoryAddress || '0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73'
    );
  }

  protected override get initCodeHash() {
    return (
  ...
  constructor(
    ...
    protected config: PancakeSwapConfig
  ) {
    super(pairs, config);
  }
}
